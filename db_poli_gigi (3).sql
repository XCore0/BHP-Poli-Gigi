...
--
-- Host: localhost:3306
-- Generation Time: May 08, 2026 at 08:39 PM
...
(4, 'BHP 02', 'masker', 0, 5, 5, 1, 1),
(7, 'BHP6833', 'Amoc', 0, 5, 7, 2, 2),
...
(103, 6, 'Edo', 'dokter', 'hapus_bhp', 'bhp', 'Menghapus BHP ID 9.', '::1', '2026-05-08 01:28:49'),
(104, 6, 'Edo', 'dokter', 'catat_pemakaian', 'stok', 'Mencatat pemakaian BHP tgl 2023-10-10 - 1 item.', '0.0.0.0', '2026-05-08 01:53:38'),
(105, 6, 'Edo', 'dokter', 'catat_pemakaian', 'stok', 'Mencatat pemakaian BHP tgl 2026-05-07 - 1 item.', '::1', '2026-05-08 01:56:40'),
(106, 6, 'Edo', 'dokter', 'catat_pemakaian', 'stok', 'Mencatat pemakaian BHP tgl 2026-05-07 - 1 item.', '::1', '2026-05-08 01:57:40'),
(107, 4, 'Fatqul Iman', 'admin', 'login', 'auth', 'Fatqul Iman berhasil masuk ke sistem.', '::1', '2026-05-08 12:59:02'),
(108, 4, 'Fatqul Iman', 'admin', 'logout', 'auth', 'Fatqul Iman keluar dari sistem.', '::1', '2026-05-08 13:08:41'),
(109, 7, 'Isan hadi', 'kepala_klinik', 'login', 'auth', 'Isan hadi berhasil masuk ke sistem.', '::1', '2026-05-08 13:09:27'),
(110, 7, 'Isan hadi', 'kepala_klinik', 'logout', 'auth', 'Isan hadi keluar dari sistem.', '::1', '2026-05-08 22:50:59'),
(111, 4, 'Fatqul Iman', 'admin', 'login', 'auth', 'Fatqul Iman berhasil masuk ke sistem.', '::1', '2026-05-08 22:51:09'),
(112, 4, 'Fatqul Iman', 'admin', 'logout', 'auth', 'Fatqul Iman keluar dari sistem.', '::1', '2026-05-09 02:25:37'),
(113, 4, 'Fatqul Iman', 'admin', 'login', 'auth', 'Fatqul Iman berhasil masuk ke sistem.', '::1', '2026-05-09 02:25:45'),
(114, 4, 'Fatqul Iman', 'admin', 'logout', 'auth', 'Fatqul Iman keluar dari sistem.', '::1', '2026-05-09 02:28:21'),
(115, 6, 'Edo', 'dokter', 'login', 'auth', 'Edo berhasil masuk ke sistem.', '::1', '2026-05-09 02:28:31'),
(116, 6, 'Edo', 'dokter', 'ganti_password', 'pengguna', 'Mengganti kata sandi.', '::1', '2026-05-09 02:30:46'),
(117, 6, 'Edo', 'dokter', 'logout', 'auth', 'Edo keluar dari sistem.', '::1', '2026-05-09 02:30:55'),
(118, 6, 'Edo', 'dokter', 'login', 'auth', 'Edo berhasil masuk ke sistem.', '::1', '2026-05-09 02:31:05'),
(119, 6, 'Edo', 'dokter', 'logout', 'auth', 'Edo keluar dari sistem.', '::1', '2026-05-09 02:38:43'),
(120, 4, 'Fatqul Iman', 'admin', 'login', 'auth', 'Fatqul Iman berhasil masuk ke sistem.', '::1', '2026-05-09 02:38:53');
...
(9, '2023-10-10', 6, 'IGD', 'Test Pasien', NULL, '2026-05-08 01:53:38'),
(10, '2026-05-07', 6, 'scalling', 'davi', NULL, '2026-05-08 01:56:40'),
(11, '2026-05-07', 6, 'apalah', 'le', NULL, '2026-05-08 01:57:40');
...
(6, 'Edo', 'dokter@poligigi.com', NULL, 'Laki-laki', NULL, NULL, '$2y$10$LBTXGyuOYttZB2tcc7iAcOFjQy0nWoW2fffzxPJYfXwiCQa3KzgqW', 'dokter', 'aktif'),
...
--
ALTER TABLE `log_aktivitas`
  MODIFY `id_log` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `pemakaian_bhp`
--
ALTER TABLE `pemakaian_bhp`
  MODIFY `id_pemakaian` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `user_preferensi`
  MODIFY `id_preferensi` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
