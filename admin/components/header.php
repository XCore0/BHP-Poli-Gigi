    ...
    <div class="flex items-center gap-6 px-4 sm:px-8 bg-white/80 shrink-0">
      ...
      <button class="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity"
        ...
        <div
          ...
          style="background: linear-gradient(135deg, #c7d2fe 0%, #6366f1 100%); color: #1e1b4b;">
          A
        </div>

        <!-- Name & role -->
        <div class="flex flex-col items-start gap-0 text-left hidden sm:flex">
          <span class="font-plex font-semibold text-sm text-[#101828] leading-5 whitespace-nowrap">Administrator</span>
          <span class="font-plex font-medium text-xs leading-4 text-indigo-600 whitespace-nowrap">Admin</span>
        </div>
