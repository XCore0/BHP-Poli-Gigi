      <div class="w-full p-4 sm:p-6 lg:p-8">
        <div class="max-w-[1400px] mx-auto space-y-6 w-full">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 px-6 py-6 sm:px-8 sm:py-7">
              <div class="flex items-center gap-4 sm:gap-5 min-w-0">
                ...
                <div class="flex flex-col gap-1 min-w-0">
                  <h1 class="font-display font-bold text-white text-xl sm:text-2xl lg:text-3xl leading-tight">Dashboard Administrator</h1>
                  <p class="font-plex font-medium text-white/90 text-[13px] sm:text-[14px] leading-relaxed hidden sm:block max-w-2xl">
                    Kelola seluruh data, pengguna, dan konfigurasi sistem manajemen BHP Poli Gigi.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p class="font-display font-bold text-2xl text-slate-800 leading-tight">12</p>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p class="font-display font-bold text-2xl text-slate-800 leading-tight">28</p>
          ...
          <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
            <i class="fas fa-server text-4xl text-slate-200 mb-3"></i>
            <h3 class="font-display font-bold text-slate-500 text-lg">Panel Kontrol Sistem</h3>
            <p class="font-plex text-sm text-slate-400 mt-1">Tabel log aktivitas dan ringkasan sistem akan ditampilkan di sini.</p>
          </div>
